...
func (p *PrepareCmd) Execute(_ context.Context, f *flag.FlagSet, _ ...interface{}) subcommands.ExitStatus {
	...
	if p.askSudoPassword {
		logrus.Errorf("[Deprecated] -ask-sudo-password WILL BE REMOVED FOR SECURITY REASONS IN A FUTURE RELEASE. Define NOPASSWD in /etc/sudoers on tareget servers and use SSH key-based authentication")
		return subcommands.ExitFailure
	}
